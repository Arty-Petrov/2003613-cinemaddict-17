...
import { convertMinutesToHM, cutStringLength } from '../util.js';
...
const createFilmCardTemplate = (film) => {
  ...
  const commentsCountString = `${comments.length} ${(comments.length === 1) ? 'comment': 'comments'}`;
  ...
  return (
    `<article class="film-card">
      <a class="film-card__link">
        ...
        <span class="film-card__comments">${commentsCountString}</span>
      </a>
